...
function Navbarbasemodel(){
    ...
    if (dis==false) {
        ...
        return (
            <Box zIndex="1000" bg="#f7f7f7" w="100vw" h="100vh" position="absolute" right="0" top="0" overflow="hidden">
                ...
                <Link to="/" cursor="pointer">
                    ...
                    <CloseIcon color="black" w="20px" h="20px" onClick={changedis} display={{base:"block", lg:"none"}}/>
                </Flex>
                <Accordion allowToggle  w="fit-content" m="auto" border="none">
                    <AccordionItem>
                        <h2>
                        <AccordionButton>
                            <Box flex='1' textAlign='center' color="black" as="b" fontSize="24px">
                            Tools
                            </Box>
                        ...
                        <AccordionPanel pb={4}>
                            <Flex direction="column" gap="15px" color="black" as="b" fontSize="18px">
                                <Text>Publish</Text>
                                <Text>Analyze</Text>
                                <Text>Engage</Text>
                ...
                <Flex direction="column" gap="15px" color="black" alignItems="center" as="b" fontSize="24px" mt="15px" mb="15px">
                <Text>Pricing</Text>
                <Text>Blog</Text>
                <Button bg="skyblue" w="fit-content" fontSize="20px" p="20px" mb="15px">Get started now</Button>
                <Text><Link to="/">Log in</Link></Text>
                </Flex>
