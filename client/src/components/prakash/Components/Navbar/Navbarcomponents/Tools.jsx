    ...
    <Menu isOpen={isOpen}>
      ...
      <MenuList onMouseEnter={onOpen} onMouseLeave={onClose} w="300px" p="10px">
        <MenuItem p="10px" borderRadius="10px">
          <Flex gap="10px">
            <Image
              src="https://i.ibb.co/CJzGTXC/Screenshot-2022-09-28-103820.png"
              w="2rem"
              h="2rem"
            />
            <Flex direction="column">
              ...
              <Text fontSize="sm" color="rgb(99, 99, 99)">
        ...
        <MenuItem p="10px" borderRadius="10px">
          <Flex gap="10px">
            <Image
              src="https://i.ibb.co/bzhwQ56/Screenshot-2022-09-28-103950.png"
              w="2rem"
              h="2rem"
            />
            <Flex direction="column">
        ...
        <MenuItem p="10px" borderRadius="10px">
          <Flex gap="10px">
            <Image
              src="https://i.ibb.co/GQFPgvq/Screenshot-2022-09-28-104021.png"
              w="2rem"
              h="2rem"
            />
            <Flex direction="column">
        ...
        <MenuItem p="10px" borderRadius="10px">
          <Flex gap="10px">
            <Image
              src="https://i.ibb.co/dKgWYgT/Screenshot-2022-09-28-104040.png"
              w="2rem"
              h="2rem"
            />
            <Flex direction="column">
              ...
              <Text fontSize="sm" color="rgb(99, 99, 99)">
                Build a customize landing page in minutes
              </Text>
            </Flex>
          </Flex>
        </MenuItem>
