  ...
  return (
    <Box>
      ...
      <Box mt="150px">
        ...
        >
          ...
          >
            <g fill="currentColor" fill-rule="evenodd">
              <path d="M18.159.966a8.36 8.36 0 0 1 .444 2.706v1.865h-4.668V.687h-3.761l.1.281c.297.874.444 1.799.444 2.721v9.386h3.217V8.21h4.668v4.866h3.217V.688h-3.761l.1.278zM37.245 5.09c.991 0 1.47.545 1.616 1.799l2.853-.166c-.149-1.137-.395-1.716-1.071-2.458-.857-.924-2.014-1.403-3.515-1.403-3.067 0-5.13 2.111-5.13 5.262 0 3.085 1.98 5.13 4.967 5.13 1.681 0 2.985-.561 3.86-1.699.528-.644.742-1.171.874-2.243l-2.853-.165c-.18 1.171-.742 1.715-1.698 1.715-1.22 0-1.716-.825-1.716-2.838-.002-1.994.56-2.934 1.813-2.934zM28.32 8.702c0 .527.05 1.204-.28 1.65a1.751 1.751 0 0 1-1.352.676c-.776 0-1.122-.412-1.122-1.286V3.077h-2.87v6.665c0 1.403.131 1.896.56 2.506.513.725 1.436.957 2.26 1.006 1.09.083 2.458-.132 3.12-1.123.1.396.231.874.246.94h2.36V3.075l-2.953.017.032 5.61zM52.322 3.077h-2.984s-3.761 4.354-3.959 4.586V.685h-3.431l.1.298a8.36 8.36 0 0 1 .444 2.706v9.403h2.87V10.52l1.782-1.98 2.16 4.537h3.382L49.304 6.48l3.018-3.402zM77.132 4.959V3.077h-2.804v9.996h2.97V8.998c0-2.08.857-3.185 3.019-3.185V2.86c-1.255.004-2.756.68-3.185 2.099zM84.043 4.959V3.077H81.24v9.996h2.97V8.998c0-2.08.857-3.185 3.019-3.185V2.86c-1.254.004-2.738.68-3.185 2.099zM94.85 3.077l-1.914 5.674-1.896-5.674H87.92l3.597 9.996-.925 2.853h2.392c.28-.808 3.893-11.514 4.354-12.866h-2.492v.017h.002z"></path>
              <path
                ...
                fill-rule="nonzero"
              ></path>
              <path d="M6.167 5.073l-.264-.33.346.233c.776.495 1.55.94 2.31 1.32a7.735 7.735 0 0 0 .297-1.633C6.464 2.569 5.226.622 4.897.06 4.567.622 3.347 2.567.94 4.663c.049.544.149 1.088.298 1.633a25.06 25.06 0 0 0 2.308-1.32l.347-.232-.264.33A23.009 23.009 0 0 1 .395 8.306c.017.578.1 1.154.246 1.715 1.418-.527 2.673-1.137 4.24-1.979L3.527 9.66v.115c0 1.122-.18 2.243-.544 3.3h3.81a10.226 10.226 0 0 1-.545-3.3V8.768c.808.413 1.65.791 2.87 1.27a9.902 9.902 0 0 0 .247-1.716 24.398 24.398 0 0 1-3.2-3.249z"></path>
            </g>
          </svg>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <g fill="currentColor" fill-rule="evenodd">
              <path
                ...
                fill-rule="nonzero"
              ></path>
              <path d="M823.7.72h13.27c.07.65.19 1.26.2 1.86.02 2.64.01 5.28.01 7.92 0 56.56.01 113.11-.02 169.67 0 5.72.5 11.34 2.23 16.81 3.58 11.36 11.09 19.43 21.27 25.23 7.27 4.14 15.16 6.35 23.43 7.23 9.87 1.05 19.66.58 29.22-2.29 10.77-3.22 19.96-8.93 27.01-17.79 5.28-6.63 8.09-14.28 8.79-22.7.24-2.86.32-5.75.32-8.63.02-58 .01-115.99.01-173.99V.8h13.77v2.66c0 59.04-.01 118.07.01 177.11 0 8.47-1.02 16.78-4.26 24.66-6.52 15.9-18.22 26.6-33.96 32.98-11.54 4.68-23.67 5.83-36.02 5.4-11-.38-21.58-2.56-31.52-7.36-12.81-6.19-22.7-15.37-28.61-28.51-3.05-6.79-4.58-13.95-5.02-21.36-.14-2.31-.12-4.64-.12-6.96-.01-58.48 0-116.95 0-175.43-.01-1.01-.01-2.04-.01-3.27z"></path>
              <path
        ...
        <Spacer mt={{ base: "40px", lg: "100px" }} />
        <Box
          position="relative"
          className="movingDivBox"
        ...
        >
          ...
          >
            ...
            >
              ...
              <Image src="https://i.ibb.co/ZL9sFxj/Screenshot-2022-09-29-124136.png" />
              <Text
                fontFamily="Poppins, sans-serif"
                mt={{ base: "25px", lg: "40px" }}
              >
        ...
        >
          <Box>
            ...
            <Text fontFamily="Roboto, sans-serif">in business</Text>
          </Box>
          <Box>
            <Text
              fontSize={{ base: "32px", lg: "42px" }}
            ...
            <Text fontFamily="Roboto, sans-serif">users</Text>
          </Box>
          <Box>
            <Text
              fontSize={{ base: "32px", lg: "42px" }}
            ...
            <Text fontFamily="Roboto, sans-serif">monthly blog readers</Text>
          </Box>
          <Box>
            <Text
              fontSize={{ base: "32px", lg: "42px" }}
        ...
        <Spacer mt="100px" />
        <Box>
          <Text fontFamily="Poppins, sans-serif" mb="20px">
        ...
        <Flex>
          <Image
            src="https://i.ibb.co/xLtffhB/Screenshot-2022-09-29-172846.png"
          ...
          <Image
            src="https://i.ibb.co/ZKt9pmq/Screenshot-2022-09-29-172926.png"
            display={{ base: "none", lg: "flex" }}
          />
        </Flex>
        <Spacer mt="100px" />
